...
namespace TDMT_DOAN.Areas.Admin.Controllers
{
    public class AdminProducerController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Edit(NHASANXUAT collection)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        [HttpDelete]
        public ActionResult Delete(NHASANXUAT collection)
        {
            try
            {
